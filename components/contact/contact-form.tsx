      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            required
            className="min-h-[150px] border-gray-300 bg-gray-50 px-4 py-3 focus:border-red-500 focus:ring-red-500"
          />
        </div>
        ...
        <div className="pt-4">
          <Button
            type="submit"
            className="w-full rounded-md bg-red-600 py-3 text-base font-medium transition-all duration-300 hover:bg-red-700 hover:shadow-lg md:w-auto md:px-8"
          >
            SEND MESSAGE
          </Button>
        </div>
