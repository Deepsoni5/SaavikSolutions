      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between">
          ...
          <div className="mt-6 md:mt-0">
            <Button className="rounded-full bg-red-600 px-8 py-2 text-sm font-medium uppercase hover:bg-red-700">
              EXPLORE MORE
            </Button>
          </div>
        </div>
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 lg:grid-cols-3">
          {/* Web Development */}
          <div className="rounded-lg bg-white p-6 shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            <div className="mb-4 flex items-start">
              <div className="flex h-10 w-10 items-center justify-center rounded bg-indigo-100">
                <Globe className="h-6 w-6 text-indigo-600" />
              </div>
              <h3 className="ml-3 text-lg font-semibold text-black">
                Web
                <br />
                Development
              </h3>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            <div className="mb-4 flex items-start">
              ...
              <h3 className="ml-3 text-lg font-semibold text-black">ERP Solutions</h3>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            <div className="mb-4 flex items-start">
              ...
              <h3 className="ml-3 text-lg font-semibold text-black">CRM Solutions</h3>
            </div>
          </div>
